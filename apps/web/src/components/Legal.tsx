            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground">
                  <strong>The Ultimate Closers</strong>, représentée par{' '}
                  <strong>Abdenacer Maredj</strong>
                  <br />
                  E-mail :{' '}
                  <a
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  <strong>3 ans après le dernier contact</strong>, sauf obligation légale contraire.
                  Les données anonymisées peuvent être conservées plus longtemps à des fins
                  statistiques.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Certaines données peuvent être analysées via des outils d'intelligence
                  artificielle pour améliorer l'expérience client et personnaliser nos services.
                  <strong>Aucun profilage discriminatoire n'est effectué</strong> et tous les
                  traitements respectent les principes éthiques de notre entreprise.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Les données sont hébergées sur des serveurs conformes RGPD situés dans l'Union
                  Européenne. Aucun transfert non autorisé n'est réalisé vers des pays tiers sans
          ...
          <div id="mentions-legales" className="bg-background rounded-lg border p-6 mb-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground">
                  <strong>The Ultimate Closers</strong> – fondé par{' '}
                  <strong>Abdenacer Maredj</strong>
                  <br />
                  E-mail :{' '}
                  <a
                  ...
                  <br />
                  Site web :{' '}
                  <a href="https://theultimateclosers.com" className="text-primary hover:underline">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Le site est hébergé sur <strong>GitHub Pages</strong> et <strong>Vercel</strong>
                  <br />
                  Serveurs conformes aux normes européennes de sécurité et de protection des
                  données.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Tous les contenus (textes, visuels, vidéos, logos, design, code source) sont la
                  propriété exclusive de <strong>The Ultimate Closers</strong>. Toute reproduction,
                  diffusion ou modification sans autorisation écrite préalable est interdite et peut
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  The Ultimate Closers ne peut être tenu responsable des dommages directs ou
                  indirects liés à l'utilisation du site ou de ses outils IA. L'utilisateur reste
                  seul responsable de l'usage qu'il fait des informations fournies et des conseils
                  prodigués.
                </p>
              </div>
          ...
          <div id="securite-cookies" className="bg-background rounded-lg border p-6 mb-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                  <li>
                    Le site utilise le protocole <strong>HTTPS</strong> pour toutes les
                    communications
                  </li>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Nécessaires au bon fonctionnement du site (préférences de langue, session
                      utilisateur).
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Google Analytics, utilisés uniquement à des fins de performance et
                      d'amélioration de l'expérience utilisateur (données anonymisées).
                    </p>
                  </div>
                  <div>
                    <h4 className="font-medium text-base mb-2">Cookies marketing</h4>
                    <p className="text-muted-foreground text-sm">
                      Utilisés pour améliorer la pertinence des annonces et des contenus (avec
          ...
          <div className="bg-primary/5 rounded-lg border p-6">
            <div className="text-center">
              ...
              <p className="text-muted-foreground mb-4">
                Pour toute question concernant nos politiques de confidentialité, nos mentions
                légales ou notre politique de sécurité, contactez-nous :
              </p>
              <Button asChild>
                <a href="mailto:contact@theultimateclosers.com">contact@theultimateclosers.com</a>
              </Button>
            </div>
          </div>
        </div>
