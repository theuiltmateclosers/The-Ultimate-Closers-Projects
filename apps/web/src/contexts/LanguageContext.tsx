...
const translations = {
  fr: {
    ...
    'mission.text':
      "Chez The Ultimate Closers, chaque conversion est une conversation honnête. L'IA amplifie la compréhension, jamais la manipulation.",
  ...
  en: {
    ...
    'mission.text':
      'At The Ultimate Closers, every conversion is an honest conversation. AI amplifies understanding, never manipulation.',
  ...
  dar: {
    ...
    'mission.text':
      'عندنا في The Ultimate Closers، كل عملية بيع هي محادثة صادقة. الذكاء الاصطناعي يعزز الفهم، ماشي التلاعب.',
